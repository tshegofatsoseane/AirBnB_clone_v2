...
class DBStorage:
    ...
    def all(self, cls=None):
        """Query on the database session all objects of the class.
    ...
    def reload(self):
        """Create all the tables in the database and initialize a session."""
    ...
    def close(self):
        """End the working SQLAlchemy session."""
